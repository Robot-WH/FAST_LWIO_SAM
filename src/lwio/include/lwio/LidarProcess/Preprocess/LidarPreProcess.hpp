...
public:
    struct Option {
        ...
        typename SlamLib::pointcloud::VoxelGridFilter<_PointT>::Option voxelGridFilter_option_;
        typename SlamLib::pointcloud::OutlierRemovalFilter<_PointT>::Option outlierRemovalFilter_option_; 
    };
public:
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    LidarPreProcess() {}
