...
public:
    ...
    */
    void Correct(double const& timestamp, _ObsType const& observation, Eigen::MatrixXd const& V,
            _StateType &states, Eigen::Matrix<double, _ErrorStateDim, _ErrorStateDim> &cov) override {   
        // 更新时间
...
protected:                       
     ...
     * @param  states 当前状态 
     */
    virtual Eigen::VectorXd computeResidual(_ObsType const& observation, _StateType const& states) = 0;  
