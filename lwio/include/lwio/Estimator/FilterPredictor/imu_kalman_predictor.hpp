...
public:
    ...
    ImuKalmanPredictor(Option option) : option_(option) {} 

    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     * @brief: 构造函数  IMU运动学模型可设置  
     */            
    ImuKalmanPredictor(float const& acc_noise, 
 ...
 */    
template<>
void ImuKalmanPredictor::computerCovMatrix<StatesWithImu, 15>(StatesWithImu const&states, 
 ...
 */    
template<>
void ImuKalmanPredictor::Predict<StatesWithImu, 15>(StatesWithImu &states, 
        ImuDataConstPtr const& curr_data, Eigen::Matrix<double, 15, 15> &cov) {
